...
# V0.2.17  避免 Nuitka 靜態追蹤 customtkinter，改由執行時外部載入。
...
def add_external_package_paths() -> list[Path]:
    ...
    for path in candidates:
        ...
        for child_name in ("PIL", "pymupdf", "numpy.libs", "bin"):
            add_dll_search_path(resolved / child_name)
...
class PDFWatermarkApp:
    ...
    def build_ui(self):
        ...
        self.paned.add(preview, weight=6)
